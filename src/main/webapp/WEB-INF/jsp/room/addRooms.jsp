...
<!--房间添加的表单-->
<div style="display: none;margin-top: 20px;" id="addRoomsDiv">
    <!--做文件上传的div-->
    <div class="layui-upload" align="center" style="margin-bottom: 20px;">
        <div class="layui-upload-list">
            <img class="layui-upload-img" id="demo1" src="img/13.jpg" width="150px" height="150px"/>
            <p id="demoText"></p>
        </div>
        <button type="button" class="layui-btn" id="test1">上传图片</button>
        <button type="button" class="layui-btn layui-btn-normal" id="test2">开始上传</button>
    </div>

    <form class="layui-form layui-form-pane" action="" style="margin-left: 50px;">
        <input type="hidden" name="roomPic" id="roomPicId" value="13.jpg"/>
