...
<!--房间类型添加的div-->
<div style="display: none;margin-top: 20px;" id="addRoomTypeDiv">
...
<div style="display: none;margin-top: 20px;" id="updRoomTypeDiv">
    <form class="layui-form layui-form-pane" lay-filter="xgRoomTypeFromFilter" action="" style="margin-left: 50px;">
